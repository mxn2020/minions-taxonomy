# Manual Setup Steps for Minions Taxonomy
...
Go to **GitHub → mxn2020/minions-taxonomy → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-taxonomy` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-taxonomy-web`
- **GitHub repo**: `mxn2020/minions-taxonomy`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `taxonomy.minions.wtf`

### Documentation
- **Netlify site name**: `minions-taxonomy-docs`
- **GitHub repo**: `mxn2020/minions-taxonomy`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `taxonomy.minions.help`

### Blog
- **Netlify site name**: `minions-taxonomy-blog`
- **GitHub repo**: `mxn2020/minions-taxonomy`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `taxonomy.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `taxonomy.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `taxonomy.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `taxonomy.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-taxonomy/sdk`](https://www.npmjs.com/package/@minions-taxonomy/sdk)
- CLI: [`@minions-taxonomy/cli`](https://www.npmjs.com/package/@minions-taxonomy/cli)
...
Your package: [`minions-taxonomy`](https://pypi.org/project/minions-taxonomy/)
...
| Item | Value |
|------|-------|
| Project | `minions-taxonomy` |
| SDK (npm) | `@minions-taxonomy/sdk` |
| CLI (npm) | `@minions-taxonomy/cli` |
| Python (PyPI) | `minions-taxonomy` |
| GitHub | `github.com/mxn2020/minions-taxonomy` |
| Docs domain | `taxonomy.minions.help` |
| Blog domain | `taxonomy.minions.blog` |
| App domain | `taxonomy.minions.wtf` |
